 ...
 */
import * as fromSounds from './sound';
 ...
 */
// export const getBookEntities = compose(fromSounds.getBookEntities, getBooksState);
// export const getBookIds = compose(fromSounds.getBookIds, getBooksState);
// export const getSelectedBook = compose(fromSounds.getSelectedBook, getBooksState);
